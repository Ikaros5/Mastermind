...
/**
 * Ventana que se encarga de gestionar una partida de dificultad extrema
 */
public class ventanaPartidaExtrema extends JFrame implements ActionListener{
    ...
    private Color[] colores = {Color.RED, Color.YELLOW, Color.GREEN, Color.BLUE, Color.ORANGE, Color.MAGENTA, Color.CYAN, Color.PINK};
	...
	public ventanaPartidaExtrema(int id) {		
		this.idP = id;
		...
		panel_casillas.setBounds(41, 396, 650, 72);
		panel_casillas.setLayout(new GridLayout(1, 0, 0, 0));
		
		botones_casillas = new JButton[6];
        ...
        panel_combinacion.setBounds(430, 283, 510, 63);
        panel_combinacion.setLayout(new GridLayout(1, 0, 0, 0));
		
        botones_combinacion = new JButton[6];
		...
		lblCasillas.setBounds(41, 379, 60, 15);
		...
		lblColores.setBounds(37, 505, 78, 15);
		
		JLabel label_1 = new JLabel("");
		label_1.setFont(new Font("FreeSerif", Font.BOLD, 14));
		label_1.setForeground(new Color(0, 0, 0));
		label_1.setBounds(142, 301, 207, 63);
		...
		tglbtnAyuda.setBounds(37, 307, 91, 39);
		
		JScrollPane Intentos = new JScrollPane();
		Intentos.setBounds(41, 70, 559, 195);
		...
		lblPuntuacin.setBounds(359, 17, 140, 41);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(621, 70, 319, 195);
		
		JLabel label_2 = new JLabel("-");
		label_2.setFont(new Font("FreeSerif", Font.BOLD, 20));
		label_2.setForeground(new Color(0, 0, 0));
		label_2.setBounds(481, 17, 78, 41);
		...
		lblCombinacinSecreta.setBounds(267, 277, 153, 15);
		...
		btnComprueba.setBounds(724, 369, 216, 225);
		    ...
		    public void actionPerformed(ActionEvent e) {
		    	if (CtrlPresentacion.getRol(idP).equals("CodeBreaker")) {
		    		if (rowCount < 10) {
		    			...
		    			table.getColumnModel().getColumn(4).setCellRenderer(new ColorCellRenderer(allSelectedColors));
		    			table.getColumnModel().getColumn(5).setCellRenderer(new ColorCellRenderer(allSelectedColors));
		    		...
		    		if (counter == 2 && !enter) {
		    			...
		    			CtrlPresentacion.actualizarRankingExtremo(id);
	    			...
	    			table.getColumnModel().getColumn(4).setCellRenderer(new ColorCellRenderer(result));
	    			table.getColumnModel().getColumn(5).setCellRenderer(new ColorCellRenderer(result));
		...
		panel_rol.setBounds(682, 29, 243, 29);
